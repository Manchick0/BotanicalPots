...
#
execute if block ~ ~ ~ minecraft:potted_oak_sapling run return run loot spawn ~ ~ ~ loot pots:pot/oak_sapling
execute if block ~ ~ ~ minecraft:potted_spruce_sapling run return run loot spawn ~ ~ ~ loot pots:pot/spruce_sapling
execute if block ~ ~ ~ minecraft:potted_birch_sapling run return run loot spawn ~ ~ ~ loot pots:pot/birch_sapling
execute if block ~ ~ ~ minecraft:potted_jungle_sapling run return run loot spawn ~ ~ ~ loot pots:pot/jungle_sapling
execute if block ~ ~ ~ minecraft:potted_acacia_sapling run return run loot spawn ~ ~ ~ loot pots:pot/acacia_sapling
...
execute if block ~ ~ ~ minecraft:potted_warped_fungus run return run loot spawn ~ ~ ~ loot pots:pot/warped_fungus
...
execute if block ~ ~ ~ minecraft:potted_golden_dandelion run return run loot spawn ~ ~ ~ loot pots:pot/golden_dandelion
...
execute if block ~ ~ ~ minecraft:potted_crimson_roots run return run loot spawn ~ ~ ~ loot pots:pot/crimson_roots
execute if block ~ ~ ~ minecraft:potted_warped_roots run return run loot spawn ~ ~ ~ loot pots:pot/warped_roots
execute if block ~ ~ ~ minecraft:potted_closed_eyeblossom run return run loot spawn ~ ~ ~ loot pots:pot/closed_eyeblossom
execute if block ~ ~ ~ minecraft:potted_open_eyeblossom run return run loot spawn ~ ~ ~ loot pots:pot/open_eyeblossom
