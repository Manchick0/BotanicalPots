...
I've randomly discovered the `pots:pot/spawn` function couldn't load due to a typo. This quick hotfix resolves that. Alongside the hotfix, we're renaming the "Tree Tinder" advancement to a less vulgar name, adding the missing Russian advancement translations, fixing a typo in the English translation of the "Uhm, acshwuallly..." advancement, and fixing the pack icon.

Enjoy 3.0.0!

# 🪴 Botanical Pots 3.0.0
...
It's a common myth that plants enjoy listening to music. Despite some studies showing that vibrations from the sound waves can stimulate some internal processes in plants, it's highly unlikely that music helps the plants in any way. _Luckily, we're making a fucking game; it has to be **fun**_.
...
We're introducing a way for other datapacks to inject new plants to Botanical Pots. You can truly do all sorts of things with this change! Please refer to the [Add-Ons 101](https://github.com/Manchick0/BotanicalPots/blob/master/ADDONS-101.md) for a comprehensive guide.